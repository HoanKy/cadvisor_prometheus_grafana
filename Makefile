...
down:
	docker compose down
up:
	docker compose down && docker compose up -d nginx nginx_prometheus_exporter cadvisor telegraf prometheus grafana
dev:
	docker compose down && docker compose up nginx nginx_prometheus_exporter cadvisor telegraf prometheus grafana
prod:
